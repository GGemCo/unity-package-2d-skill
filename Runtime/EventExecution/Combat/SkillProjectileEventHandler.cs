    ...
    internal static class SkillProjectileEventHandler
    {
            ...
            SkillAttackSequence attackSequence)
        {
            ...
            var meta = new MetadataProjectile(
                ...
                flightSoundLifetimePolicy: def.flightSoundLifetimePolicy,
                impactSound: def.impactSound,
                impactSoundTrigger: def.impactSoundTrigger,
                impactSoundRepeatPolicy: def.impactSoundRepeatPolicy,
